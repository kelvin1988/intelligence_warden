...
public class SocketServer {
    ...
    public void startSocketServer(int port) {
        System.out.println("startSocketServer,threadId:" +Thread.currentThread().getId());
        try {
            //打开通信信道
            ...
            System.out.println(Calendar.getInstance().getTime().toString() + " --- SocketServer begin to listen connect request ...");
            while (true) {
